...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Places, reads, and useful discoveries',
      description: 'Explore places, curated reads, articles, and useful local context through a cleaner reading-first experience.',
      openGraphTitle: 'Places, reads, and useful discoveries',
    ...
    hero: {
      ...
      title: ['A thoughtful home for', 'places, reads, and discovery.'],
      ...
      searchPlaceholder: 'Search places, reads, topics, and more',
      focusLabel: 'Focus',
    ...
    intro: {
      ...
      paragraphs: [
        'This site brings together curated reading, local discovery, and structured browsing so visitors can move naturally between different content types.',
  ...
  about: {
    ...
    paragraphs: [
      ...
      'Whether someone starts with an place, read, image post, or resource page, they can continue exploring without losing context.',
    ],
    values: [
      {
      ...
      },
      {
        ...
        description: 'places, reads, visual posts, resources, and profiles stay connected so discovery feels natural across the site.',
      },
      {
